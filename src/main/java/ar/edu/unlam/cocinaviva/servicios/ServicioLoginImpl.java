...
// ser manejado por el framework, debe indicarse en applicationContext que busque en el paquete ar.edu.unlam.cocinaviva.servicios
...
public class ServicioLoginImpl implements ServicioLogin {
	...
	public Usuario consultarCorreoUsuario(Usuario usuario) {
		return servicioLoginDao.consultarCorreoUsuario(usuario);
	}
