...
<title>Yo Cocino Todo &mdash;</title>
			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div id="gtco-logo">
							<a href="home">Yo Cocino Todo <em>.</em></a>
						</div>
					</div>
					...
					<div class="col-md-12 col-md-offset-0 text-left">
						...
						<div class="row row-mt-15em">
							<div class="col-md-7 mt-text animate-box"
								...
								<h2 class="cursive-font">Unite a esta comunidad saludable!</h2>
									...
									<div class="tab">
										...
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												...
												<h2 class="cursive-font"><a href="registro">Regístrate</a></h2>
											</div>
			...
			<div class="gtco-container">
				<div class="row row-pb-md">
					...
					<div class="col-md-12 text-center copyright">
						<p>
							<small class="block">&copy; 2018 YO COCINO TODO SA. TODOS
